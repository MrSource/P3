...
public class SortedCircularDoublyLinkedList<E extends Comparable<E>> implements SortedList<E> {
	 ...
	 * add 
	 * @param <obj>
	 * return true if added the obj, false if not added
	 */
	 ...
	 * remove 
	 * @param <obj>
	 * return true if remove the obj, false if not remove
	 */
	 ...
	 * removeAll 
	 * @param <obj>
	 * return the number of elements that has been removed
	 */
	 ...
	 * contains 
	 * @param <E>
	 * return true if element e is on the list
	 */
	...
	/**
	 * isEmpty 
	 * return true if the current size of the list is greater than 1
	 * 
	 */
