...
app.controller('StoreController', ['$http', function($http) {
   ...
   $http.get("/getGems").success(function (data) {
...
//when the function is sucesful resets the products 
	$http.post("/gem", gem).success(function name(data) {
...
store.updateGem = function(gemId, gem){
    ...
    $http.put("/gem/"+gemId, gem).success(function name(data){
    });
...
store.getGems = function(){
 ...
 location.reload();
  ...
  app.directive("productReviews", function() {
    return {
      restrict: 'E',
      templateUrl: "/assets/product-review.html"
    };
  });
  ...
  app.directive("updateReviews", function() {
    return {
      restrict: 'E',
      templateUrl: "/assets/product-update.html"
    };
  });
